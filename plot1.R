...
# and plots the Global Active Power values as a histogram for the dates February 1-2 of 2007.
...
png (file = 'plot1.png', width = 480, height = 480)  # Create a PNG file, specifying 480 by 480 pixels in size
hist (target$Global_active_power, col = "red", xlab = "Global Active Power (kilowatts)", 
      main = "Global Active Power")  # Plot the histogram
